...
{
    size_t id_length = create_identifier(buffer, Construction::primitive, Class::universal, UniversalTag::integer);
    if (id_length == 0)
    {
        return 0;
    }
...
inline size_t Integer::encode_content_and_length(absl::Span<uint8_t> buffer) const noexcept
{
