...
TEST_CASE("Identifier: Encode ImplicitIdentifier")
{
    ...
    size_t                   size =
        fast_ber::encode(absl::Span<uint8_t>(buffer.begin(), buffer.size()), i,
...
TEST_CASE("Identifier: Decode ExplicitIdentifier")
{
    ...
    bool                   success =
        fast_ber::decode(iterator, i, fast_ber::ExplicitIdentifier<fast_ber::UniversalTag::integer>{});
...
TEST_CASE("Identifier: Decode ImplicitIdentifier")
{
    ...
    fast_ber::Integer      i        = 500;
    bool                   success  = fast_ber::decode(
        iterator, i, fast_ber::ImplicitIdentifier<fast_ber::Class::context_specific, 20>{});
