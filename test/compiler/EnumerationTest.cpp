...
{
    fast_ber::Enumerations::NumberedEnumeration numbered = fast_ber::Enumerations::NumberedEnumeration::Values::blue;
...
TEST_CASE("Enumeration: Encode Decode")
{
    ...
    REQUIRE(fast_ber::encode(absl::Span<uint8_t>(data), enum_one,
                ...
                .success);
    REQUIRE(fast_ber::decode(data, enum_two, fast_ber::ExplicitId<fast_ber::UniversalTag::enumerated>{}).success);
